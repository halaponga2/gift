...
answer_song.src = 'sounds/song1.mp3'
var anwer='5252544';
...
function check(){
if (guess.indexOf('5252544')!=-1){
    document.getElementById('correct').style.display="block";
    answer_song.play();
    setTimeout(function(){location.href="music2.html"},5000);
    guess="0";
}}
...
function hint(){
    if (active == 0){
        ...
        hint1.innerHTML = 'Песня "В траве сидел кузнечик"';
...
function answer(){
    if (active==1){
        ...
        hint2.innerHTML = 'Фа, До, Фа, До, Фа, Ми, Ми';
